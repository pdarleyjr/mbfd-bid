...
describe('Rehearsal findings CRUD (Task R6)', () => {
  ...
  beforeEach(async () => {
    ...
    await h.db.run(
      "INSERT INTO members (id,employee_id,first_name,last_name,rank,bid_category,rsc_seniority,is_probationary,employment_status,created_at,updated_at) VALUES (7,'7admin','Synthetic','Admin','CHIEF','EXCLUDED',0,0,'retired',0,0)",
    );
