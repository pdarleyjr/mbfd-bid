...
export const GUIDE_SECTIONS: readonly GuideSection[] = [
  ...
  section({
    ...
    steps: [
      'In Participants & flow, set the order for each stage and connect it to the resolved policy decision. Department seniority and time in grade can require different recorded fields. Confirm the source mapping; a similar field name is not enough. Missing facts or unresolved ties prevent that order from being used.',
      ...
      'Record existing membership distributions only from a reviewed roster. Select the members, shifts and per-shift and per-group limits explicitly; this does not add another staffing position.',
    ],
    important:
  ...
  section({
    ...
    controls: ['Results', 'Bid run', 'Refresh results', 'Decision history'],
    steps: [
    ...
    important:
      'Results and History are read-only. Viewing them does not create or start a run, record an award, publish results or apply Department staffing changes.',
