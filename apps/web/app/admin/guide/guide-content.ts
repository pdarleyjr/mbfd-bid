...
export const GUIDE_SECTIONS: readonly GuideSection[] = [
  section({
    ...
    steps: [
      ...
      'In Prepare Next Bid, review the seat participation and canonical holder. Active protection blocks biddable participation and mismatched holder evidence. Expired protection does not close a future annual seat automatically.',
    ],
    important:
  ...
  section({
    ...
    title: 'Prepare Next Bid',
    route: '/admin/annual-plan',
    routeLabel: 'Prepare Next Bid',
    summary:
