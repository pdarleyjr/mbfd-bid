...
export const GUIDE_SECTIONS: readonly GuideSection[] = [
  ...
  section({
    ...
    steps: [
      ...
      'In A-Day, enable simultaneous selection only when supported by the policy. Enter the source and any exact officer count. Name each limit and select its actual positions, members, ranks and shifts. A label does not choose its members automatically.',
